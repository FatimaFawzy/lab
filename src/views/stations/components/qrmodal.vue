<template>
     <Dialog v-model:visible="qrDialog" modal :header="record.name" :style="{ width: '60rem' }">
          <div class="border-top-1 border-bluegray-100">
               <div ref="qrcode" class="text-center pt-4">
                    ...
                    <div class="py-5 flex justify-content-center align-content-center gap-2">
               ...
               <div class="flex justify-content-end gap-2 border-top-1 border-bluegray-100 mt-3 pt-3">
                    <Button size="small" label="الغاء" severity="danger" @click="qrDialog = false"></Button>
...
<script>
     ...
     export default {
          computed: {
               ...mapWritableState(useStationsStore, ["record", "qrDialog"]),
          },
          methods: {
               async downloadPdf() {
